...
globalThis.__ELECTROBUN__ = true;
globalThis.__electrobunShowConfirm = async (title, message, okLabel, cancelLabel) => {
...
globalThis.__electrobunShowError = async (title, message) => {
