const en = {
  ...
  bookOcrReviewScreen: {
    title: "Cover OCR",
    processing: "Reading cover text...",
    detectedFields: "Detected metadata",
    noDetectedFields: "No metadata candidates were detected from the cover.",
